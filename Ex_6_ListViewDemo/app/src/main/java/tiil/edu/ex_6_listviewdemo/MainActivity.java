package tiil.edu.ex_6_listviewdemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //3.3 Lăn nghe và sử lý sự kiện user tương tác
        //Gắn bộ lắng nghe vào
        lvTenTinhThanh.setOnItemClickListener(BoLangNghevaXL);

    }
    //tạo bộ lắng nghe và xu lý sự kiện onitemclick, dat vao mot bien
    //vd bo lăng nghe va xu lý
